<x-app-layout>
    ...
    <div class="flex bg-white mx-auto my-4 p-4 rounded-lg border border-black max-w-5xl">
        ...
        <div class="">
            ...
            <a href="{{route('admin.solicitudes.cambioEstado', ['id' => $refundRequest->id, 'newState' => 'approved'])}}">
                <button id="aprobarButton" class="bg-green-500 hover:bg-green-700 text-white p-3 m-2 rounded">
                    Aprobar Solicitud
                </button>
            </a>
            <a href="{{route('admin.solicitudes.cambioEstado',['id' => $refundRequest->id, 'newState' => 'disapproved'])}}">
