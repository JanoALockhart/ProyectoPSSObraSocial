                    ...
                    @foreach ($clients as $client)
                        ...
                        <li class="list-group-item flex justify-between items-center mt-4 mb-4 bg-gray-100 p-4 rounded-lg">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <a
                                    href="{{ route('admin.showClientMinors', $client->id) }}"
                                    class="btn btn-primary border-4 border-stone-500 px-4 py-2 hover:bg-gray-700 hover:text-white transition duration-300 ease-in-out">
                                ...
                                <a
                                    {{-- Colocar ruta que lleva al formulario para asignar menor --}}
                                    href="#"
                                    class="btn btn-primary border-4 border-stone-500 px-4 py-2 hover:bg-gray-700 hover:text-white transition duration-300 ease-in-out">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                    Asignar Menor
