<x-app-layout>
    ...
    <div class="grow">
            ...
            <a href="{{route('empleado.solicitudes.cambioEstado', ['id' => $benefitRequest->id, 'newState' => 'approved'])}}">
                <button id="aprobarButton" class="bg-green-500 hover:bg-green-700 text-white p-3 m-2 rounded">
                    Aprobar Solicitud
                </button>
            </a>
            <a href="{{route('empleado.solicitudes.cambioEstado',['id' => $benefitRequest->id, 'newState' => 'disapproved'])}}">
