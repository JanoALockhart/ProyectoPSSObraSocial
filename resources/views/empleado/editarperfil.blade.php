    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-700 mx-auto">
                <form action="{{ route('employeeUpdateProfile') }}" method="POST" class="myForm">
                    @csrf
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ route('employeeProfile') }}" class="btn btn-secondary border border-gray-700 rounded-full px-4 py-2 mr-2 hover:bg-gray-700 hover:text-white transition duration-300 ease-in-out">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
